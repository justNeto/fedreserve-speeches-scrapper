...
class FederalScrapper():
    ...
    def __init__(self, browser="chrome", headless=False, speaker="powell", debug=False, download_dir=None):
    ...
    def run(self):
        ...
        try:
            ...
            print(f"::!->\n Error occurred at link extraction: {e}")
            self.teardown_method()
            exit(1)
